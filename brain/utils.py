        ...
        for a in range(15):
            if availablestep[i][a] == 49:
                ...
                if rstep==True and board[i]!=EN_CHESS[15] and board[i]!=EN_CHESS[14] and i!=size - 1:
                    if ((board[i]==EN_CHESS[0] or board[i]==EN_CHESS[0]) and (board[i+1]==EN_CHESS[6] or board[i+1]==EN_CHESS[6])) or ((board[i+1]==EN_CHESS[0] or board[i+1]==EN_CHESS[0]) and (board[i]==EN_CHESS[6] or board[i]==EN_CHESS[6])):
                        power[15]=0
                        power[31]=0
                        hp[15]=0
                        hp[31]=0
                    ...
                    if ((board[i]==EN_CHESS[0] or board[i]==EN_CHESS[0]) and (board[i+ro]==EN_CHESS[6] or board[i+ro]==EN_CHESS[6])) or ((board[i+ro]==EN_CHESS[0] or board[i+ro]==EN_CHESS[0]) and (board[i]==EN_CHESS[6] or board[i]==EN_CHESS[6])):
                        power[15]=0
                        power[31]=0
                        hp[15]=0
                        hp[31]=0
