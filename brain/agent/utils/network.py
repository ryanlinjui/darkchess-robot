...
def _configure_tensorflow_gpu() -> None:
    try:
        ...
        # If TensorFlow runtime is already initialized or no GPU is present,
        # keep the default behavior instead of crashing on import.
        pass
...
def build_policy_value_model(
    ...
    - aux: current-player color and eaten-piece histogram
    Outputs are:
